...
import com.example.mad_23012011030_Pr7.db.DatabaseHelper
        ...
        CoroutineScope(Dispatchers.IO).launch {
            try {
                val data = HttpRequest().makeServiceCall(
                    reqUrl = "https://api.json-generator.com/templates/0PiTk4qs0c0V/data",
                    token = "258e24rrg0igzs4vveifj0wleqmfy6bx8iti5x4v"
                )
